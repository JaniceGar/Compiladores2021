//Garcia SamperioJanice Amairani


// No se manejar bien las clases en C++, no estoy muy familiarizada con el lenguaje :
#include <iostream>
#include <vector>
#include <algorithm>
#include <string>
...
void menu(){
    ...
    cout << "\t 2. Verificar que la palabra esté dentro \n";
    cout << "\t 3. Salir                          \n";
    cout << "\t Ingrese opcion: ";
}
